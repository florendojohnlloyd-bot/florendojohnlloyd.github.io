...
function render() {
  ...
  } catch(e) { /* swallow render errors so loader always completes */ }
}
render();
...
if (!loaderEl || !lBar || !lPct) {
  /* loader elements missing — just run heroIn directly */
...
/* Hard fallback — if loader somehow stalls, force heroIn after 4s */
setTimeout(() => {
  if (!heroFired) {
    heroFired = true;
